...
struct TransferFactoryRequest
{
    transfer_instruction_v1::TransferFactory_Transfer choiceArguments;
    bool excludeDebugFields;
};
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TransferFactoryRequest, choiceArguments, excludeDebugFields)
} // namespace daml::model::request

namespace nlohmann
{
template <> struct adl_serializer<daml::model::request::CommandWrapper>
{
...
template <> struct adl_serializer<daml::model::request::FilterVariant>
{
